...
```mermaid
graph TD
    A[Prólogo: Villa Tranquimar & Mudanza] --> B[Profesor Ceibo: Elección Filosófica del Inicial]
    B --> C[Llegada a Metrópolis Solsticio]
    C --> D[Segunda Elección: Compañero Base]
    D --> E[Gimnasios 1-4: Primeras Señales & Ruinas]
    E --> F[Incidente Central: Tragedia de Nahuel & Lesión de Arcanine]
    F --> G[Ruptura: Nahuel como Antagonista Trágico]
