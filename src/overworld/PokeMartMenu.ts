...
export class PokeMartMenu {
  ...
  static readonly CATALOGS: Record<string, ShopItem[]> = {
    ...
    pueblo_altiplano: [
      ...
      { id: 'antidote',     name: 'Antídoto',     price: 400,  sellPrice: 200, description: 'Cura el envenenamiento de un Pokémon.',                category: 'medicine' },
      { id: 'fire_stone',   name: 'Piedra Fuego', price: 3000, sellPrice: 1500, description: 'Piedra que irradia calor y hace evolucionar Pokémon.', category: 'battle_item' },
      { id: 'link_cable',   name: 'Cordón Unión', price: 5000, sellPrice: 2500, description: 'Evoluciona Pokémon de intercambio de forma directa.',  category: 'battle_item' },
    ],
    metro_solsticio: [
      { id: 'poke_ball',    name: 'Poké Ball',    price: 200,   sellPrice: 100,  description: 'Dispositivo básico de captura.',                        category: 'ball'        },
      { id: 'great_ball',   name: 'Super Ball',   price: 600,   sellPrice: 300,  description: 'Mayor tasa de captura.',                                category: 'ball'        },
      { id: 'ultra_ball',   name: 'Ultra Ball',   price: 1200,  sellPrice: 600,  description: 'Alta tasa de captura para Pokémon fuertes.',             category: 'ball'        },
      ...
      { id: 'revive',       name: 'Revivir',      price: 1500,  sellPrice: 750,  description: 'Revive a un Pokémon debilitado con mitad de PS.',        category: 'medicine'    },
      { id: 'link_cable',   name: 'Cordón Unión', price: 5000,  sellPrice: 2500, description: 'Evoluciona Pokémon que antes requerían intercambio.',   category: 'battle_item' },
      { id: 'fire_stone',   name: 'Piedra Fuego', price: 3000,  sellPrice: 1500, description: 'Piedra evolutiva elemental de fuego.',                  category: 'battle_item' },
      { id: 'water_stone',  name: 'Piedra Agua',  price: 3000,  sellPrice: 1500, description: 'Piedra evolutiva elemental de agua.',                   category: 'battle_item' },
      { id: 'thunder_stone',name: 'Piedra Trueno',price: 3000,  sellPrice: 1500, description: 'Piedra evolutiva elemental eléctrica.',                category: 'battle_item' },
      { id: 'leaf_stone',   name: 'Piedra Hoja',  price: 3000,  sellPrice: 1500, description: 'Piedra evolutiva elemental de planta.',                 category: 'battle_item' },
      { id: 'metal_coat',   name: 'Rev. Metálico',price: 5500,  sellPrice: 2750, description: 'Uso directo: Evoluciona a Onix y Scyther.',             category: 'battle_item' },
      { id: 'adamant_mint', name: 'Menta Firme',  price: 2500,  sellPrice: 1250, description: 'Menta aromática: +Ataque, -Ataque Especial.',           category: 'battle_item' },
      { id: 'modest_mint',  name: 'Menta Modesta',price: 2500,  sellPrice: 1250, description: 'Menta aromática: +Ataque Especial, -Ataque.',           category: 'battle_item' },
      { id: 'jolly_mint',   name: 'Menta Alegre', price: 2500,  sellPrice: 1250, description: 'Menta aromática: +Velocidad, -Ataque Especial.',        category: 'battle_item' },
      { id: 'timid_mint',   name: 'Menta Miedosa',price: 2500,  sellPrice: 1250, description: 'Menta aromática: +Velocidad, -Ataque.',                 category: 'battle_item' },
      { id: 'garchompite',  name: 'Garchompita',  price: 45000, sellPrice: 22500,description: 'Mega Piedra telúrica para desatar a Mega-Garchomp.',   category: 'key_item'    },
      { id: 'lucarionite',  name: 'Lucarionita',  price: 40000, sellPrice: 20000,description: 'Mega Piedra telúrica para desatar a Mega-Lucario.',    category: 'key_item'    },
    ],
  };
