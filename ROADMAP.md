...
| 2.6 | Menú `POKÉMON`: relevo táctico en combate | — | ⬜ |
| 2.7 | Menú `MOCHILA`: uso de Pociones y Poké Balls en combate | — | ⬜ |
| 2.8 | Captura con Poké Ball: parabólica, rebotes, ratio, jingle | — | ⬜ |
| 2.9 | EXP y subida de nivel: barra azul fluida, +Stats, nuevos movimientos | — | ⬜ |

### 🏥 FASE 3 — Servicios de Pueblo y Primer Gimnasio

| # | Tarea | Módulo | Estado |
|---|-------|--------|--------|
| 3.1 | Centro Pokémon: Joy, animación curación, jingle | — | ⬜ |
| 3.2 | Tienda Pokémon: catálogo, compra x1/x5/x10, venta | `ui/pokemartMenu.ts` | ⬜ |
| 3.3 | Entrenadores por visión: ícono `!`, caminata automática, desafío | — | ⬜ |
| 3.4 | Gimnasio Altiplano: Líder Rocío (Geodude Nv.12, Onix Nv.14), Medalla Cumbre | — | ⬜ |

### 💾 FASE 4 — PC, Ficha de Entrenador y Guardado

| # | Tarea | Módulo | Estado |
|---|-------|--------|--------|
| 4.1 | PC de Almacenamiento: 8 cajas, Depositar / Retirar / Mover | — | ⬜ |
| 4.2 | Ficha de Entrenador: avatar, dinero, tiempo, vitrina 8 medallas | — | ⬜ |
| 4.3 | Guardado / Carga: `localStorage`, pantalla de carga visual | `core/saveManager.ts` | ⬜ |

### 🌟 FASE 5 — Clima, Biomas y Mega-Evolución

| # | Tarea | Módulo | Estado |
|---|-------|--------|--------|
| 5.1 | Ciclo Día/Noche: overlay de color, Pokémon nocturnos | `overworld/timeCycle.ts` | ⬜ |
| 5.2 | Clima dinámico: lluvia, arena, sol — partículas + combate | — | ⬜ |
| 5.3 | Surf acuático y HM: tile de agua transitable | — | ⬜ |
| 5.4 | Mega-Evolución: cinemática, HUD Mega Ring, stats en BattleManager | `core/megaEngine.ts` | ⬜ |
...
type BattleStepType =
  ...
  | 'CRITICAL_HIT' | 'EFFECTIVENESS' | 'FAINT' | 'BATTLE_END';
...
interface MapWarp {
  ...
  transitionType?: 'door_fade' | 'slide_up' | 'slide_down' | 'instant';
}
...
**Próximo paso:** Tarea 1.8 — Desniveles de salto (Ledge) con Tween parabólico.

---

*Última actualización: 2026-08-25 | Próxima tarea: 1.8 Ledges*
